...
function ApplyModal({ job, onClose, onSubmitSuccess }) {
    ...
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: '600px' }}>
        ...
        {status === 'success' ? (
          ...
          <>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', pr: '2rem' }}>
              Apply for {job.title}
            </h2>
              ...
              <div className="form-group">
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '2rem 1.5rem',
                    textAlign: 'center',
                    backgroundColor: dragOver ? 'rgba(139, 92, 246, 0.05)' : 'rgba(15, 17, 26, 0.4)',
                    cursor: 'pointer',
